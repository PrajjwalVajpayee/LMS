...
const CourseDetails = () => {
  ...
  const { allCourses,getToken, calculateRating,backendUrl,userData, calculateCourseDuration, calculateNoOfLectures, calculateChapterTime, currency } = useContext(AppContext);
    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'> Course by <span className='text-blue-600 underline'>Gappoche</span></p>
                            ...
                            <div className='flex gap-2'>
                              {lecture.isPreviewFree && <p
                                onClick={() => setPlayerData({
                                  videId: lecture.lectureUrl.split('/').pop()
        ...
        {/* right column */}
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] smLmin-w-[420px]'>
          ...
          <div className='p-5'>
            <div className='flex items-center gap-2'>
              ...
              <p className='text-red-500'><span className='font-semibold'>5 days</span> left in this price</p>
            </div>
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                ...
                <li>Step-by-step, hands-on project duidance.</li>
